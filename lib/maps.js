...
// currently, movement impedement is generated from this
const treasureHunt = [
  '┌──────┬─────────────────────────┐',
  '│      │       ┌┐                │',
  '│ .  ──┤       └┘           ┌┐   │',
...
module.exports = {
    ...
    treasureHuntMovementImpedement: generateMovementImpedement(treasureHunt)
}
...
// TODO: visionImpedement for windows/glass?

function generateMovementImpedement (map) {
  const UNMOVEABLE = -1 // anything not a floor
  // TODO: different levels of impedement later
  const MOVEABLE = 1 // floor - impedement for movement in "moves"
  // const floorRegex = /[ ]/g
